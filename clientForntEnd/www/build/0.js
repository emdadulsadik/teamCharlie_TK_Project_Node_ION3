...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__user_management__ = __webpack_require__(765);
                    ...
                    handler: function () {
                        ...
                        loading.present().then(function () {
                            _this.storage.clear().then(function () {
                                ...
                                _this.appCtrl.getRootNav().setRoot(__WEBPACK_IMPORTED_MODULE_3__tabs_tabs__["a" /* TabsPage */]);
                            });
                        });
        ...
        var prompt = this.alertCtrl.create({
            ...
            buttons: [{
                ...
                },
                {
                    text: 'Save',
                    handler: function (data) {
                        var user = new __WEBPACK_IMPORTED_MODULE_5__models_user_model__["a" /* User */](data.userName, data.userRole, data.emailAddress, data.password, data.firstName, data.lastName);
                        var alert = _this.alertCtrl.create({
                            title: 'Reset Password',
