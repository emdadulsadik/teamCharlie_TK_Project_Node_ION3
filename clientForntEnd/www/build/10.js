...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__preview_modal__ = __webpack_require__(755);
...
var PreviewModalPage = (function () {
    ...
    PreviewModalPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-preview-modal',template:/*ion-inline-start:"/home/alihamza/786/Algorithm/up/ION2/TK_Project/TeamCharlie_SLT_Test/clientFrontendTest3/src/pages/preview-modal/preview-modal.html"*/'<ion-content>\n  <div class="image-modal transparent">\n    <ion-item class="close-fake" no-lines (click)="close()">\n      <ion-icon name="close"></ion-icon>\n    </ion-item>\n    <img [src]="img.url" class="fullscreen-image transparent" (click)="close()">\n    <ion-card>\n      <ion-card-content class="img-info" *ngIf="img.desc">\n        <div class="desc-text">"{{ img.desc }}"</div>\n        <p>\n          <ion-icon name="calendar" item-left *ngIf="img.created"></ion-icon>\n          {{ img.created | date: \'short\' }}\n        </p>\n      </ion-card-content>\n    </ion-card>\n  </div>\n</ion-content>'/*ion-inline-end:"/home/alihamza/786/Algorithm/up/ION2/TK_Project/TeamCharlie_SLT_Test/clientFrontendTest3/src/pages/preview-modal/preview-modal.html"*/,
        }),
