...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SetCyclingPageModule", function() { return SetCyclingPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(32);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__set_cycling__ = __webpack_require__(726);
...
var SetCyclingPageModule = (function () {
    function SetCyclingPageModule() {
    }
    SetCyclingPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__set_cycling__["a" /* SetCyclingPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__set_cycling__["a" /* SetCyclingPage */]),
            ],
        })
    ], SetCyclingPageModule);
    return SetCyclingPageModule;
}());

//# sourceMappingURL=set-cycling.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return SetCyclingPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(32);
...
var SetCyclingPage = (function () {
     ...
     */
    function SetCyclingPage(navCtrl, navParams, storage, geolocation, stActivityProvider) {
        var _this = this;
     ...
     * @memberOf SetCyclingPage
     */
    SetCyclingPage.prototype.ionViewDidLoad = function () {
     ...
     * @memberOf SetCyclingPage
     */
    SetCyclingPage.prototype.goToRootAgain = function () {
        var _this = this;
     ...
     * @memberOf SetCyclingPage
     */
    SetCyclingPage.prototype.startCycling = function () {
        var _this = this;
            ...
            geocoder.geocode({ 'latLng': latLng }, function (results, status) {
                ...
                this.storage.get('userId').then(function (userId) {
                    _this.stActivityProvider.setStartActivitiesInfo(bodyObject, userId, startpoint, _this.activity).subscribe(function (data) {
                        console.log(data);
                        _this.storage.set('setActivitiesIDForCycling', data.setActivitiesID);
     ...
     * @memberOf SetCyclingPage
     */
    SetCyclingPage.prototype.endCycling = function () {
        var _this = this;
        this.geolocation.getCurrentPosition().then(function (location) {
            var latLng = new google.maps.LatLng(location.coords.latitude, location.coords.longitude);
            var mapOptions = {
            ...
            geocoder.geocode({ 'latLng': latLng }, function (results, status) {
                ...
                var bodyObject = new __WEBPACK_IMPORTED_MODULE_5__models_setActivites__["a" /* SetActivity */](latLng);
                console.log(latLng.lat);
                this.storage.get('setActivitiesIDForCycling').then(function (setActivitiesIDForCycling) {
                    _this.stActivityProvider.setEndActivitiesInfo(bodyObject, setActivitiesIDForCycling, endpoint).subscribe(function (data) {
                        console.log(data);
                    }, function (error) {
                        console.log(error);
                    });
     ...
     * @memberOf SetCyclingPage
     */
    SetCyclingPage.prototype.addInfoWindow = function (marker, content) {
        var _this = this;
     ...
     * @memberOf SetCyclingPage
     */
    SetCyclingPage.prototype.getCyclingRecordsData = function () {
        var _this = this;
        this.storage.get('setActivitiesIDForCycling').then(function (setActivitiesIDForCycling) {
            _this.stActivityProvider.getCyclingRecords(setActivitiesIDForCycling).subscribe(function (data) {
     ...
     * @memberOf SetCyclingPage
     */
    SetCyclingPage.prototype.getDistanceFromLatLonInKm = function (lat1, lon1, lat2, lon2) {
     ...
     * @memberOf SetCyclingPage
     */
    SetCyclingPage.prototype.deg2rad = function (deg) {
     ...
     * @memberOf SetCyclingPage
     */
    SetCyclingPage.prototype.TimeforHumans = function (seconds) {
        var levels = [
     ...
     * @memberOf SetCyclingPage
     */
    SetCyclingPage.prototype.shareActivity = function (activity, index) {
        console.log('We will do');
    };
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_8" /* ViewChild */])('map'),
        __metadata("design:type", __WEBPACK_IMPORTED_MODULE_0__angular_core__["t" /* ElementRef */])
    ], SetCyclingPage.prototype, "mapElement", void 0);
    SetCyclingPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-set-cycling',template:/*ion-inline-start:"/home/alihamza/786/Algorithm/up/ION2/TK_Project/Totaly_New_From_Scratch/clientForntEnd/src/pages/set-cycling/set-cycling.html"*/'\n<ion-header>\n\n  <ion-navbar>\n    <ion-title>setCycling</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n<ion-content padding="true">\n  <div #map id="map"></div>\n  <ion-grid>\n    <ion-row>\n      <ion-col>\n        <button ion-button block  type="button" icon-left (click)="startCycling()">\n          <ion-icon name="arrow-dropup-circle"></ion-icon>\n          Start Cycling\n        </button>\n      </ion-col>\n      <ion-col>\n        <button ion-button block color="rosyBrown" type="button" icon-left (click)="endCycling()">\n          <ion-icon name="arrow-dropdown-circle"></ion-icon>\n          End Cycling\n        </button>\n      </ion-col>\n    </ion-row>\n\n    <ion-row  *ngFor="let activity of setActivity; let i=index">\n      <ion-col *ngIf="hide">\n        <ion-card>\n          <ion-item>\n            Congratulation You made below records\n            <h2>Distance: {{activity.distance}} - Km </h2>\n            <p>Total Time Taken:{{activity.timedelta}} </p>\n\n            <p>You Start From:{{activity.startpoint}} </p>\n            <p>You Finished To:{{activity.endpoint}} </p>\n          </ion-item>\n\n          <ion-row>\n            <ion-col>\n                <p>Wanna Chalange your friends, click this button </p>\n              <button ion-button color="secodary" full block (click)="shareActivity(activity,i)">\n                <ion-icon name=\'share\'></ion-icon>  Share It\n              </button>\n            </ion-col>\n          </ion-row>\n        </ion-card>\n      </ion-col>\n      </ion-row>\n\n\n\n  </ion-grid>\n\n</ion-content>\n\n\n<ion-footer class="txtPos">\n  <ion-toolbar>\n    <ion-title>\n      <button color="gohstWhite" ion-button clear (click)="goToRootAgain()"> Back</button>\n    </ion-title>\n  </ion-toolbar>\n</ion-footer>\n'/*ion-inline-end:"/home/alihamza/786/Algorithm/up/ION2/TK_Project/Totaly_New_From_Scratch/clientForntEnd/src/pages/set-cycling/set-cycling.html"*/,
        }),
    ...
    return SetCyclingPage;
}());

//# sourceMappingURL=set-cycling.js.map
